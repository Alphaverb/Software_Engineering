...
### Дан текстовый файл, содержащий некоторое количество слов. Необходимо реализовать случайную подстановку слов из файла в выделенные места заданных предложений. Вывести получившиеся предложения в консоль.
### Данные в файле:
### словарь, кирпич, диплом, шуруповерт, гель для душа, годовой запас бумаги, корвалол, мешок картошки, замок, самосвал, билет в один конец, скотч, финальный вариант курсовой, чайный гриб.
### Предложения:
